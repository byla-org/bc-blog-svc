...
exports.updateBlog = async (req, res, next) => {
  ...
  try {
    ...
    if (blog.user.toString() !== user) {
      //await produceMessage(`User with id ${user} is not authorized to update this blog`);
...
exports.deleteBlog = async (req, res, next) => {
  ...
  try {
    ...
    //check if the user is the owner
    if (blog.user.toString() !== user) {
      //await produceMessage(`User with id ${user} is not authorized to delete this blog`);
      throw new ErrorResponse(
